...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Psych Engine Custom v" + psychEngineVersion, 12);
	...
	function changeItem(huh:Int = 0)
	{
		...
		menuItems.forEach(function(spr:FlxSprite)
		{
			...
			if (spr.ID == curSelected)
			{
				...
				spr.centerOffsets();
				// FlxTween.tween(spr, {x: spr.x + 500}, 4, {ease: FlxEase.elasticInOut});
