...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/teddytony/Modded-Psych-For-My-Mods/main/gitVersion.txt");
		...
		// IGNORE THIS!!!
		titleJSON = Json.parse(Paths.getTextFromFile('data/JSON/gfDanceTitle.json'));
